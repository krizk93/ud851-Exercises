...
public class NotificationUtils {
    ...
    private static final int ID_PENDING_INTENT = 3000;
    private static final int ID_WATER_REMINDER_NOTIFICATION = 1234;
    private static final String ID_CHANNEL = "reminder-notification-channel";
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        NotificationChannel mChannel = new NotificationChannel(ID_CHANNEL,context.getString(R.string.main_notification_channel_name),NotificationManager.IMPORTANCE_HIGH);
        notificationManager.createNotificationChannel(mChannel);
        }
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,ID_CHANNEL)
        ...
        notificationManager.notify(ID_WATER_REMINDER_NOTIFICATION,notificationBuilder.build());
    }
    ...
    private static PendingIntent contentIntent(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context,ID_PENDING_INTENT,intent,PendingIntent.FLAG_UPDATE_CURRENT);
