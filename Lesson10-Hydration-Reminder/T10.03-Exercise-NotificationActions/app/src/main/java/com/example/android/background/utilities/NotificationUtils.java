...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 4444;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 2345;
    /**
    ...
    //      COMPLETED (16) Return the action
        ...
        public static NotificationCompat.Action drinkWaterAction(Context context){
            ...
            NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(R.drawable.ic_drink_notification,"I did it!",drinkWaterPendingIntent);
