...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent incrementWaterCounterIntent = new Intent(this, WaterReminderIntentService.class);
        incrementWaterCounterIntent.setAction(ACTION_INCREMENT_WATER_COUNT);
        startService(incrementWaterCounterIntent);
    }
